    ...
    _createClass(Tooltip, [{
      ...
      value: function show() {
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          __WEBPACK_IMPORTED_MODULE_0__util__["default"].reflow(tip);
  ...
  var Carousel = function () {
    ...
    _createClass(Carousel, [{
      ...
      value: function pause(event) {
        ...
        if ($(this._element).find(Selector.NEXT_PREV)[0] && __WEBPACK_IMPORTED_MODULE_0__util__["default"].supportsTransitionEnd()) {
          __WEBPACK_IMPORTED_MODULE_0__util__["default"].triggerTransitionEnd(this._element);
          this.cycle(true);
        }
      ...
      value: function _slide(direction, element) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__util__["default"].supportsTransitionEnd() && $(this._element).hasClass(ClassName.SLIDE)) {

          $(nextElement).addClass(orderClassName);

          __WEBPACK_IMPORTED_MODULE_0__util__["default"].reflow(nextElement);

          $(activeElement).addClass(directionalClassName);
          $(nextElement).addClass(directionalClassName);

          $(activeElement).one(__WEBPACK_IMPORTED_MODULE_0__util__["default"].TRANSITION_END, function () {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tooltip__ = __webpack_require__(1);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var Popover = function ($) {
  ...
  var Default = $.extend({}, __WEBPACK_IMPORTED_MODULE_0__tooltip__["default"].Default, {
    placement: 'right',
    trigger: 'click',
    content: '',
  ...
  var DefaultType = $.extend({}, __WEBPACK_IMPORTED_MODULE_0__tooltip__["default"].DefaultType, {
  ...
  var Popover = function (_Tooltip) {
    ...
    return Popover;
  }(__WEBPACK_IMPORTED_MODULE_0__tooltip__["default"]);
    ...
    _createClass(ScrollSpy, [{
      ...
      value: function refresh() {
        ...
        targets.map(function (element) {
          var target = void 0;
          var targetSelector = __WEBPACK_IMPORTED_MODULE_0__util__["default"].getSelectorFromElement(element);
      ...
      value: function _getConfig(config) {
        ...
        if (typeof config.target !== 'string') {
          ...
          if (!id) {
            id = __WEBPACK_IMPORTED_MODULE_0__util__["default"].getUID(NAME);
  ...
  var Tab = function () {
    ...
    _createClass(Tab, [{
      ...
      value: function _activate(element, container, callback) {
        ...
        var isTransitioning = callback && __WEBPACK_IMPORTED_MODULE_0__util__["default"].supportsTransitionEnd() && (active && $(active).hasClass(ClassName.FADE) || Boolean($(container).find(Selector.FADE_CHILD)[0]));
...
Component.options.__file = "E:\\Code\\Default\\resources\\assets\\js\\components\\Example.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4b79619e", Component.options)
  } else {
    hotAPI.reload("data-v-4b79619e", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4b79619e", module.exports)
  }
}
